...
namespace Ghostly
{
    public class Process
    {
        ...
        public Process(string[] args, IGhostlyJS ghostlyJS)
        {
            ...
            _natives_exports["tty_wrap"] = Util.GetResource("tty_wrap");
            ...
            _natives_exports["jQuery"] = Util.GetResource("jQuery");
        ...
        public object binding(string args)
        {
            ...
            {
                //return _jsVm.Exec("(function(exports){" + (string)_natives_exports[args] + "; return exports; })({})");
